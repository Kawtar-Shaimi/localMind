...
<form class="max-w-2xl mx-auto bg-white p-8 rounded-3xl shadow-2xl border border-gray-300 space-y-6">
  <h2 class="text-3xl font-extrabold text-gray-900 text-center">Edit Question</h2>
  ...
  <button type="submit" class="w-full text-black font-semibold py-4 rounded-2xl shadow-lg">
    Update Question
  </button>
</form>
